...
userRouter.get("/trails/:trail_id", trailControllers.viewTrail);
userRouter.post("/trails/add", trailControllers.addTrail);
userRouter.post("/trails/:trail_id/delete", trailControllers.deleteTrail);
