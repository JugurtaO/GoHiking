...
userRouter.post("/login", sanitize_1.sanitize, userControllers.postLogin);
userRouter.post("/signup", sanitize_1.sanitize, userControllers.postSignup);
userRouter.post("/logout", sanitize_1.sanitize, userControllers.postLogout);
userRouter.post("/signout", sanitize_1.sanitize, userControllers.postSignout);
